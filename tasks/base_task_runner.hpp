...
public:
    ...
    virtual void run_all(std::ostream& stream = std::cout) = 0; // not const to save task arguments
    virtual void run_by_name(const std::string& name, std::ostream& stream = std::cout) = 0; // not const to save task arguments
