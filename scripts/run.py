...
if __name__ == '__main__':
    ...
    parent_compilation_parser.add_argument('--lib', help="Path to Eigen library source directory", default=None)
    ...
    compilation_parser = subparsers.add_parser("compilation", parents=[base_parent_parser, parent_compilation_parser, parent_multicompilation_parser], help="Sourse files compilation")
    compilation_parser.add_argument("--type", help="Type of binary to compile", choices=["experiment", "perf", "test", "eigen"], required=True)
    ...
    experiment_parser = subparsers.add_parser("experiment", parents=[base_parent_parser, parent_compilation_parser, parent_single_compilation_parser, parent_plotting_parser, parent_result_parser, parent_suffix_parser, parent_optimization_parser], help="Full experiment run")
    ...
    performance_parser = subparsers.add_parser("perf", parents=[base_parent_parser, parent_compilation_parser, parent_multicompilation_parser, parent_optimization_parser, parent_result_parser, parent_suffix_parser], help="Performance measurements using Linux Perf")
    performance_parser.set_defaults(func=perf_measurements)

    disasm_parser = subparsers.add_parser("disasm", parents=[base_parent_parser, parent_compilation_parser, parent_multicompilation_parser], help="Disassembling using Linux Perf")
