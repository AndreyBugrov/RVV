...
def testing(args):
    ...
    full_test(compilation_profiles, args.device_name, args.no_recompile, args.show)
...
if __name__ == '__main__':
    ...
    testing_parser.add_argument('--show', help="Show full test output", action="store_true")
