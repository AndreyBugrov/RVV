    ...
    const map<string, map<FunctionOptimizationType, string>> function_types={
        pair<string, map<FunctionOptimizationType, string>>(
            ...
            map<FunctionOptimizationType, string>{
                pair<FunctionOptimizationType, string>(FunctionOptimizationType::kSimple, "simple matrix product")
            }
        ),
        pair<string, map<FunctionOptimizationType, string>>(
            object_names[kGramSchmidtProcess],
            map<FunctionOptimizationType, string>{
                pair<FunctionOptimizationType, string>(FunctionOptimizationType::kSimple, "simple Gram-Schmidt process")
            }
        ),
    };
