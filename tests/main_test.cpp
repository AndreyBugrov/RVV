    ...
    const map<object_indexes, map<FunctionOptimizationType, string>> function_types={
        ...
        pair<object_indexes, map<FunctionOptimizationType, string>>(
            ...
            map<FunctionOptimizationType, string>{
                ...
                pair<FunctionOptimizationType, string>(FunctionOptimizationType::kBlockUnrolling, "block row matrix product with unrolling"),
                ...
                pair<FunctionOptimizationType, string>(FunctionOptimizationType::kBlockUnrollingPar, "parallel block row matrix product with unrolling"),
            }
        ),
        pair<object_indexes, map<FunctionOptimizationType, string>>(
        ...
        pair<object_indexes, map<FunctionOptimizationType, string>>(
            ...
            map<FunctionOptimizationType, string>{
                ...
                pair<FunctionOptimizationType, string>(FunctionOptimizationType::kBlockUnrolling, "QR decomposition with optimal block matrix product"),
